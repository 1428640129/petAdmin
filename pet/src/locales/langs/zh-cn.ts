const local: App.I18n.Schema = {
  ...
  route: {
    ...
    bath: '洗浴服务管理',
    bath_service: '服务管理',
    bath_appointment: '预约管理',
    bath_order: '订单管理',
    bath_payment: '支付管理',
    bath_review: '评价管理',
    bath_notification: '通知管理'
  },
  page: {
    login: {
      common: {
    ...
    home: {
      ...
      projectNews: {
        title: '服务动态',
        moreNews: '更多动态',
        desc1: '用户 张三 预约了基础洗浴服务，预约时间：今天 14:00',
        desc2: '订单 #20260120001 已完成服务，用户评价：5星好评',
        desc3: '新增用户 李四 注册成功，欢迎加入宠沐！',
        desc4: '服务项目"深度护理"已完成优化，新增SPA护理功能',
        desc5: '今日已完成服务 25 单，营业额达到 5,680 元'
      },
      creativity: '快捷入口',
      quickAccess: {
        appointment: '预约管理',
        appointmentDesc: '查看和管理预约信息',
        order: '订单管理',
        orderDesc: '处理订单和支付',
        service: '服务管理',
        serviceDesc: '管理服务项目和价格',
        review: '评价管理',
        reviewDesc: '查看和处理用户评价'
      }
    },
    function: {
      tab: {
