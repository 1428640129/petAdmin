...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  bath_appointment: () => import("@/views/bath/appointment/index.vue"),
  bath_member: () => import("@/views/bath/member/index.vue"),
  bath_notification: () => import("@/views/bath/notification/index.vue"),
  bath_order: () => import("@/views/bath/order/index.vue"),
  bath_payment: () => import("@/views/bath/payment/index.vue"),
  bath_pet: () => import("@/views/bath/pet/index.vue"),
  bath_review: () => import("@/views/bath/review/index.vue"),
  bath_service: () => import("@/views/bath/service/index.vue"),
  "function_hide-child_one": () => import("@/views/function/hide-child/one/index.vue"),
  "function_hide-child_three": () => import("@/views/function/hide-child/three/index.vue"),
  "function_hide-child_two": () => import("@/views/function/hide-child/two/index.vue"),
  function_menu: () => import("@/views/function/menu/index.vue"),
  "function_multi-tab": () => import("@/views/function/multi-tab/index.vue"),
  function_request: () => import("@/views/function/request/index.vue"),
  function_role: () => import("@/views/function/role/index.vue"),
  ...
  function_user: () => import("@/views/function/user/index.vue"),
