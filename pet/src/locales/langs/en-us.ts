const local: App.I18n.Schema = {
  ...
  page: {
    ...
    home: {
      ...
      creativity: 'Quick Access',
      quickAccess: {
        appointment: 'Appointment',
        appointmentDesc: 'View and manage appointments',
        order: 'Order',
        orderDesc: 'Process orders and payments',
        service: 'Service',
        serviceDesc: 'Manage service items and prices',
        review: 'Review',
        reviewDesc: 'View and process user reviews'
      }
    },
    function: {
      tab: {
